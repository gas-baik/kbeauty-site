      ...
      <div className="max-w-xl mx-auto px-4 py-12">
        {done ? (
          <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">Booking Confirmed!</h2>
            <p className="text-gray-500 mb-8 text-sm md:text-base">Thank you {name}! We will contact you at {email} shortly.</p>
          ...
          <div className="bg-white rounded-2xl p-6 md:p-10 shadow-sm">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8">Book a Course</h2>
